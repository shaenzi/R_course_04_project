...
- [ ] try horizontal radio buttons
- [ ] lake?
- [ ] make map interactive, see [plotly documentation](https://plotly.com/r/choropleth-maps/) - does not work with quantiles?? Giulia recommends tmap/leaflet
